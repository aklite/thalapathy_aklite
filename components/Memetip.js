    ...
    return (
        <TooltipPrimitive.Provider>
            <TooltipPrimitive.Root
                ...
                <TooltipPrimitive.Trigger asChild={Slot}>
                    <button
                        className={clsx("py-1 transition-colors font-medium rounded-md hover:text-gray-900 focus:text-gray-900 focus:bg-gray-100 hover:bg-gray-100")}
                    >
                        {children}{" "}
                    </button>
